  ...
  return (
    <div>
      ...
      <div>
        ...
        {/*rating*/}
        <div className="flex item-center spcae-x-2">
          <div className="px-2 py-2 bg-blue-800 rounded-md fnt-bold text-white text-xs">
            {hotel.rating}
          </div>
        ...
        <p className="mt-3 text-gray-700 font-medium"> 
            Starting from <span className="text-blue-600 font-bold ">US${hotel.price}</span></p>
